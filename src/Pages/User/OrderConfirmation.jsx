        ...
        <div className="container py-2 text-center">
            <div className="row justify-content-center">
                <div className="col-lg-6">
                    ...
                    <h1 className="mb-4">Order Has Been Placed</h1>
                    <p className="mb-4">Thank you for shopping with Us! Your Order has been successfully placed and is now being processed. We've sent a confirmation email with your order details. You can track your order from your account dashboard, and we'll notity you as soon as It's shipped. We appreciate your trust and look forward to serving you again!</p>
