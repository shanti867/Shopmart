...
export default function HomePage() {
    ...
    useEffect(() => {
        (() => {
            ...
            if (ActiveMaincategoryStateData.length && ProductStateData.length) {
                setMaincategory(ActiveMaincategoryStateData.filter(x => ProductStateData.filter(p => p.maincategory.name === x.name).length))
            }
        })()
    ...
    return (
        <>
            ...
            <Service />
            <Offer />
            <Products maincategory={maincategory} data={ProductStateData} />
            <SaleBanner />
            ...
            <BestSellerProducts data={ProductStateData.slice(0, 24)} />
        </>
    )
}
