...
import { CREATE_BRAND, CREATE_BRAND_RED, DELETE_BRAND, DELETE_BRAND_RED, GET_BRAND, GET_BRAND_RED, GET_ACTIVE_BRAND, UPDATE_BRAND, UPDATE_BRAND_RED } from "../Constant"
...
function* getActiveSaga(){        //worker
    let response = yield getRecord("brand/active")
    yield put({type: GET_BRAND_RED, payload: response})
}
...
export default function* BrandSaga(){         
    ...
    yield takeEvery(GET_BRAND, getSaga)        //Watcher
     yield takeEvery(GET_ACTIVE_BRAND, getActiveSaga)         //Watcher
