  ...
  return (
    <>
      <div className="list-group">
        ...
        {Cookies.get("role") ==="Super Admin"?<Link to="/admin/user" className="list-group-item list-group-item-action active mb-1" aria-current="true"><i className='bi bi-people fs-5'></i><span className='float-end'>User</span></Link>
:null}
      </div>
    </>
  )
