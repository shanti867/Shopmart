     ...
     <div className="container-fluid products pb-5">
        <div className="container products-mini py-5">
            <div className="mx-auto text-center mb-5" style={{maxWidth: "700px"}}>
                ...
                <p className="mb-0 wow fadeInUp" data-wow-delay="0.2s">Discover our best-selling products loved by thousands of satisfied customers, From everyday
                    essentials to trending favorites, explore premium quality, unbeatable value, and top-rated items that shoppers trust most.
                </p>
            </div>
