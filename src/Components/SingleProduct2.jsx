                                        ...
                                        <div className="row g-0">
                                            <div className="col-5">
                                                <div className="products-mini-img border-end h-100">
                                                    <img src={`${import.meta.env.VITE_APP_IMAGE_SERVER}/product/${item.pic[0]}`} style={{height:180}} className="img-fluid w-100" alt="Image" />
                                            ...
                                            <div className="col-7">
                                                <div className="products-mini-content p-3">
                                                    <Link to={`/product/${item.id}`} className="d-block mb-2">{item.maincategory.name}/{item.subcategory.name}/{item.brand.name}</Link>
