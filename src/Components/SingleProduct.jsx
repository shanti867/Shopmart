            ...
            <div className="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                <div className="product-item-inner border rounded">
                    <div className="product-item-inner-item">
                        <img src={`${import.meta.env.VITE_APP_IMAGE_SERVER}/product/${item.pic[0]}`} style={{height:400}} className="img-fluid w-100 rounded-top" alt="" />
                    ...
                    <div className="text-center rounded-bottom p-4">
                        <Link to={`/product/${item.id}`} className="d-block mb-2">{item.maincategory.name}/{item.subcategory.name}</Link>
